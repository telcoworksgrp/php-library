...
use \TCorp\Legacy\T2\AffiliateReferral AS T2AffiliateReferral;


/**
 * Helper class for working with T3 Affiliate Referrals
 */
class AffiliateReferral
{
    ...
    public static function validateAffilateId(string $id)
    {
        return preg_match('|^[A-Z]{12}$|', $id) OR
            T2AffiliateReferral::validateAffilateId($id);
    }
